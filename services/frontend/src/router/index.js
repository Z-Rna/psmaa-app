      ...
      children: [
        {
          path: "alternatives",
          name: "alt_smaatri",
          component: () => import('../views/smaatri/AlternativesView.vue'),
        },
        {
          path: "categories",
          name: "cat_smaatri",
          component: () => import('../views/smaatri/CategoryView.vue'),
        },
        {
          path: "criterions",
          name: "cri_smaatri",
          component: () => import('../views/smaatri/CriterionsView.vue'),
        },
        {
          path: "preference",
          name: "pref_smaatri",
          component: () => import('../views/smaatri/PreferenceVue.vue'),
        },
        {
          path: "lambda",
          name: "lambda_smaatri",
          component: () => import('../views/smaatri/LambdaView.vue'),
        },
        {
          path: 'results',
          name: 'results_smaatri',
          component: () => import('../views/smaatri/ResultView.vue'),
        }
      ]
    },
  ]
