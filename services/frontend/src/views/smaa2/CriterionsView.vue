    ...
    <main>
        ...
        <ul class="cri-list">
            <CriterionItem v-for="(cri, index) in criList" :cri="cri" :index="index" @edit-cri="toggleEditCri"
                @update-cri="updateCri" @update-ascending="updateAscending" @update-type="updateType"
                @update-alt-list="updateAltList" @update-alt-list-ordinal="updateAltListOrdinal" @delete-cri="deleteCri" />
        </ul>
    </main>
</template>
